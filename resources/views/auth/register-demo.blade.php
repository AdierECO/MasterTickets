...
<body>
    <!-- Botón de casa para volver al inicio -->
                    ...
                    <div class="auth-body">
                        <form id="registerForm">
                            ...
                            <div class="form-group mb-3 fade-in">
                                ...
                                <input type="tel" class="form-control" id="telefono" placeholder="+52 5512345678" required>
                            </div>
    ...
    <script>
        ...
        document.getElementById('registerForm').addEventListener('submit', function(e) {
            ...
            // window.location.href = "/"; // Descomenta para redirección real
        });
    </script>
</body>
</html>